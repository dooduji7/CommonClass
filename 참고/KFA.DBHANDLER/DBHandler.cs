...
// 2009-12-08 v1.0.2  메소드 추가 :  ExecuteProcedure, ExecuteProcedureResult
/*
 * NAME     : DBHandler
 * PURPOSE  : database Habdler Class
 * REVISIONS:
 *   Ver        Date        Author           Description
 *  ---------  ----------  ---------------  ------------------------------------
 *  1.0.0.3    2010-01-13  KFA
 *  1.0.1      2011-04-25   JKCHOI          OracleDbAccess -> ConnectionString메소드 파라메터추가
 * 
 * 
 * 
 * */
